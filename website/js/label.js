...
const label_explanation_text_body = label_basic_explication_body.append("text").attr("x", 0).attr("y", 0).attr("class", "label_body").attr("font-size", "1.2rem").attr("fill", "#4a4a4a")
